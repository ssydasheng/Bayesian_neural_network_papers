...
2. [Practical Variational Inference for Neural Networks](https://papers.nips.cc/paper/4329-practical-variational-inference-for-neural-networks.pdf)

3. [Weight Uncertainty in Neural Networks](https://arxiv.org/abs/1505.05424)

4. [Probabilistic Backpropagation for Scalable Learning of Bayesian Neural Networks](https://arxiv.org/abs/1502.05336)

5. [Assumed Density Filtering Methods for Learning Bayesian Neural Networks](http://www.aaai.org/ocs/index.php/AAAI/AAAI16/paper/download/12391/11777)

6. [Dropout Inference in Bayesian Neural Networks with Alpha-divergences](https://arxiv.org/abs/1703.02914)

7. [Deep neural networks as Gaussian Processes](https://arxiv.org/abs/1711.00165)

8. [Noisy Natural Gradient as Variational Inference](https://arxiv.org/abs/1712.02390)
...
2. [Learning Structured Weight Uncertainty in Bayesian Neural Networks](http://people.ee.duke.edu/~lcarin/PBP_MN_aistats17.pdf)
...
4. [Variational Dropout Sparsifies Deep Neural Networks](https://arxiv.org/abs/1701.05369)
...
4. [Bayesian Optimization with Robust Bayesian Neural Networks](https://papers.nips.cc/paper/6117-bayesian-optimization-with-robust-bayesian-neural-networks.pdf)

5. [Bayesian GAN](http://papers.nips.cc/paper/6953-bayesian-gan.pdf)
